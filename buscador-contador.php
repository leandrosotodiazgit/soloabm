...
<body>
	...
	<main class=" buscador contadores">
		<div class="col-xs-12 col-md-12 offset-md-1 contenedor m-0 p-0">
			<div class="div_buscador">
				<div class="container position-relative" style="padding-top: 40px;">
					<div class="div_botones d-flex" style="top: 0;">
						<a class="btn_inicio contadores" href="/" style="top: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
								<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
								<polyline points="9 22 9 12 15 12 15 22"></polyline>
							</svg></a>
						<div class="separador"><span>|</span></div>
						<a class="btn_volver contadores" href="index-contador.php" style="top: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left">
								<line x1="19" y1="12" x2="5" y2="12"></line>
								<polyline points="12 19 5 12 12 5"></polyline>
							</svg></a>
					</div>
				</div>
				<form class="container position-relative" name="buscador" action="buscador-contador.php" method="POST">
					...
					<div class="searchable-container">
						...
						?>
							<div class="items" style="text-align: left; display:none">
								<b> <a style="color:black" href="pregunta-contador.php?pid=<?= $row["id"] ?>"><?= $row["pregunta"] ?></a></b>
							</div>
						<?php
						}
						?>
			...
			<div class="container resultados">
				<?php if (count($preguntas) > 0) : ?>
					...
					?>
						<div class="item">
							<a href="pregunta-contador.php?pid=<?= $pregunta["id"] ?>">
