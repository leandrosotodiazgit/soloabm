...
$stm = $db->prepare("SELECT preguntas.* FROM preguntas,categorias WHERE preguntas.categoria_id = categorias.id AND plataforma='empresas' AND (pregunta LIKE :criteria OR respuesta LIKE :criteria) ");
			...
			<div class="div_buscador">
				<div class="container position-relative" style="padding-top: 40px;">
					<div class="div_botones d-flex" style="top: 0;">
						...
						<a class="btn_volver empresas" href="index-empresa.php" style="top: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left">
			...
			<div class="container resultados">
				<?php if (count($preguntas) > 0) : ?>
					<?php foreach ($preguntas as $pregunta) : ?>
						<div class="item">
							<a href="pregunta-empresa.php?pid=<?= $pregunta["id"] ?>">
